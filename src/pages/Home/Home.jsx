    ...
    <div>
      <div style={ImageCenter}>
        <div style={imageWrapperStyle}>
          <img src="fon.png" alt="SoundBloom" style={imageStyle} />
          ...
          <div style={positionButton}>
            <button style={styleDiscoverNow}>Discover Now</button>
            <button style={styleCreatePlaylist}>Create Playlist</button>
          </div>
        </div>
      </div>
      <div>
