...
export default function ElasticSlider({
  ...
  isStepped = false,
  stepSize = 1,
  leftIcon = <MutedOutlined className="text-pink-400" />,
  rightIcon = <SoundOutlined className="text-pink-400" />,
  onValueChange,
    ...
    <>
      ...
      >
        <motion.div
          ...
          className="text-pink-400 text-base flex items-center"
        >
          {leftIcon}
        </motion.div>
        ...
        >
          ...
          >
            <div className="relative h-full flex-grow overflow-hidden rounded-full bg-white/20">
              <div
                className="absolute h-full rounded-full bg-gradient-to-r from-[#cb0094] to-[#ee10b0] shadow-[0_0_10px_rgba(203,0,148,0.6)]"
