...
export const CONTENT: Record<Lang, SiteContent> = {
  ...
  ru: {
    ...
    problem: {
      ...
      problems: [
        ...
        "Нужны поиск, офлайн и три языка на любом устройстве",
    ...
    features: {
      ...
      stats: [
        { value: "69+", label: "API эндпоинтов" },
        { value: "3", label: "Языка — EN · RU · KK" },
        { value: "3", label: "Источника каталога" },
  ...
  kk: {
    ...
    features: {
      ...
      stats: [
        { value: "69+", label: "API эндпоинт" },
        { value: "3", label: "Тіл — EN · RU · KK" },
        { value: "3", label: "Каталог көзі" },
